...
while True:
    ...
    if opcion == "a":
        ...
        nombre = input("Introduzca el nombre del contacto a modificar: ")
        if nombre in agenda:
            ...
            if opcion_modificacion == 1:
                ...
                print(f"Teléfono del contacto {nombre} actualizado correctamente.")
            elif opcion_modificacion == 2:
                nuevo_email = input("Introduzca el nuevo email: ")
                agenda[nombre]["email"] = nuevo_email
                print(f"Email del contacto {nombre} actualizado correctamente.")
            else:
